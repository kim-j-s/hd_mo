	...
	(p = t.cleanData),
		...
		(t.widget = function (e, i, s) {
			var n,
				...
				r = {},
				l = e.split(".")[0];
			if ("__proto__" === (e = e.split(".")[1]) || "constructor" === e) return t.error("Invalid widget name: " + e);
			var h = l + "-" + e;
			return (
				s || ((s = i), (i = t.Widget)),
				...
				t.extend(a, n, { version: s.version, _proto: t.extend({}, s), _childConstructors: [] }),
					...
					r[t] = (function () {
						...
						return function () {
							var t,
								i = this._super,
								a = this._superApply;
							return (this._super = s), (this._superApply = n), (t = e.apply(this, arguments)), (this._super = i), (this._superApply = a), t;
						};
					})();
				}),
				(a.prototype = t.widget.extend(o, { widgetEventPrefix: (n && o.widgetEventPrefix) || e }, r, { constructor: a, namespace: l, widgetName: e, widgetFullName: h })),
				n
		...
		(t.widget.extend = function (e) {
			for (var i, s, o = a.call(arguments, 1), r = 0, l = o.length; r < l; r++) for (i in o[r]) (s = o[r][i]), n.call(o[r], i) && void 0 !== s && (t.isPlainObject(s) ? (e[i] = t.isPlainObject(e[i]) ? t.widget.extend({}, e[i], s) : t.widget.extend({}, s)) : (e[i] = s));
			return e;
		}),
					...
					o
						? this.length || "instance" !== n
							? this.each(function () {
									var i,
										a = t.data(this, s);
									return "instance" === n ? ((l = a), !1) : a ? ("function" != typeof a[n] || "_" === n.charAt(0) ? t.error("no such method '" + n + "' for " + e + " widget instance") : (i = a[n].apply(a, r)) !== a && void 0 !== i ? ((l = i && i.jquery ? l.pushStack(i.get()) : i), !1) : void 0) : t.error("cannot call methods on " + e + " prior to initialization; attempted to call method '" + n + "'");
								})
							: (l = void 0)
		...
		(t.Widget.prototype = {
			...
			option: function (e, i) {
				...
				if ("string" == typeof e) {
					if (((o = {}), (e = (s = e.split(".")).shift()), s.length)) {
						for (a = 0, n = o[e] = t.widget.extend({}, this.options[e]); a < s.length - 1; a++) (n[s[a]] = n[s[a]] || {}), (n = n[s[a]]);
						...
						(o = s.classesElementLookup[n[r]] || t()),
							e.add
								? ((function () {
									...
									(o = t(t.uniqueSort(o.get().concat(e.element.get())))))
								: (o = t(o.not(e.element).get())),
			...
			_trigger: function (e, i, s) {
				var n,
					a,
					o = this.options[e];
				if (((s = s || {}), ((i = t.Event(i)).type = (e === this.widgetEventPrefix ? e : this.widgetEventPrefix + e).toLowerCase()), (i.target = this.element[0]), (a = i.originalEvent))) for (n in a) n in i || (i[n] = a[n]);
			...
			(t.position = {
				scrollbarWidth: function () {
					...
					var i,
						...
						a = n.children()[0];
					return t("body").append(n), (i = a.offsetWidth), n.css("overflow", "scroll"), i === (s = a.offsetWidth) && (s = n[0].clientWidth), n.remove(), (e = i - s);
				},
				...
				(t.fn.position = function (e) {
					...
					var l,
						...
						x = {};
					return (
						(v = 9 === (l = b[0]).nodeType ? { width: b.width(), height: b.height(), offset: { top: 0, left: 0 } } : d(l) ? { width: b.width(), height: b.height(), offset: { top: b.scrollTop(), left: b.scrollLeft() } } : l.preventDefault ? { width: 0, height: 0, offset: { top: l.pageY, left: l.pageX } } : { width: b.outerWidth(), height: b.outerHeight(), offset: b.offset() }),
						...
						t.each(["my", "at"], function () {
							var t,
								i,
								s = (e[this] || "").split(" ");
							1 === s.length && (s = n.test(s[0]) ? s.concat(["center"]) : a.test(s[0]) ? ["center"].concat(s) : ["center", "center"]), (s[0] = n.test(s[0]) ? s[0] : "center"), (s[1] = a.test(s[1]) ? s[1] : "center"), (t = o.exec(s[0])), (i = o.exec(s[1])), (x[this] = [t ? t[0] : 0, i ? i[0] : 0]), (e[this] = [r.exec(s[0])[0], r.exec(s[1])[0]]);
						}),
						1 === k.length && (k[1] = k[0]),
						...
						this.each(function () {
							var n,
								...
								h = c(this, "marginLeft"),
								d = c(this, "marginTop"),
								v = r + h + c(this, "marginRight") + w.width,
								D = l + d + c(this, "marginBottom") + w.height,
								C = t.extend({}, _),
								T = u(x.my, o.outerWidth(), o.outerHeight());
							"right" === e.my[0] ? (C.left -= r) : "center" === e.my[0] && (C.left -= r / 2),
								"bottom" === e.my[1] ? (C.top -= l) : "center" === e.my[1] && (C.top -= l / 2),
								(C.left += T[0]),
								(C.top += T[1]),
								(n = { marginLeft: h, marginTop: d }),
								t.each(["left", "top"], function (i, s) {
									t.ui.position[k[i]] && t.ui.position[k[i]][s](C, { targetWidth: f, targetHeight: g, elemWidth: r, elemHeight: l, collisionPosition: n, collisionWidth: v, collisionHeight: D, offset: [p[0] + T[0], p[1] + T[1]], my: e.my, at: e.at, within: y, elem: o });
								}),
								e.using &&
									(a = function (t) {
										var n = m.left - C.left,
											...
											h = m.top - C.top,
											u = h + g - l,
											c = { target: { element: b, left: m.left, top: m.top, width: f, height: g }, element: { element: o, left: C.left, top: C.top, width: r, height: l }, horizontal: a < 0 ? "left" : n > 0 ? "right" : "center", vertical: u < 0 ? "top" : h > 0 ? "bottom" : "middle" };
										f < r && s(n + a) < f && (c.horizontal = "center"), g < l && s(h + u) < g && (c.vertical = "middle"), i(s(n), s(a)) > i(s(h), s(u)) ? (c.important = "horizontal") : (c.important = "vertical"), e.using.call(this, t, c);
									}),
								o.offset(t.extend(C, { using: a }));
						})
					);
				}),
				(t.ui.position = {
					fit: {
						left: function (t, e) {
							var s,
								...
								l = a - r,
								h = r + e.collisionWidth - o - a;
							e.collisionWidth > o ? (l > 0 && h <= 0 ? ((s = t.left + l + e.collisionWidth - o - a), (t.left += l - s)) : h > 0 && l <= 0 ? (t.left = a) : l > h ? (t.left = a + o - e.collisionWidth) : (t.left = a)) : l > 0 ? (t.left += l) : h > 0 ? (t.left -= h) : (t.left = i(t.left - r, t.left));
						},
						top: function (t, e) {
							var s,
								n = e.within,
								...
								l = a - r,
								h = r + e.collisionHeight - o - a;
							e.collisionHeight > o ? (l > 0 && h <= 0 ? ((s = t.top + l + e.collisionHeight - o - a), (t.top += l - s)) : h > 0 && l <= 0 ? (t.top = a) : l > h ? (t.top = a + o - e.collisionHeight) : (t.top = a)) : l > 0 ? (t.top += l) : h > 0 ? (t.top -= h) : (t.top = i(t.top - r, t.top));
						},
					},
					flip: {
						left: function (t, e) {
							var i,
								...
								f = -2 * e.offset[0];
							u < 0 ? ((i = t.left + d + p + f + e.collisionWidth - r - o) < 0 || i < s(u)) && (t.left += d + p + f) : c > 0 && ((n = t.left - e.collisionPosition.marginLeft + d + p + f - l) > 0 || s(n) < c) && (t.left += d + p + f);
						},
						top: function (t, e) {
							var i,
								n,
								...
								f = -2 * e.offset[1];
							u < 0 ? ((n = t.top + d + p + f + e.collisionHeight - r - o) < 0 || n < s(u)) && (t.top += d + p + f) : c > 0 && ((i = t.top - e.collisionPosition.marginTop + d + p + f - l) > 0 || s(i) < c) && (t.top += d + p + f);
						},
					},
					flipfit: {
						left: function () {
		...
		t.fn.extend({
			disableSelection:
				((f = "onselectstart" in document.createElement("div") ? "selectstart" : "mousedown"),
				function () {
		...
		(t.ui.focusable = function (e, i) {
			...
			return "area" === l ? ((n = (s = e.parentNode).name), !!e.href && !!n && "map" === s.nodeName.toLowerCase() && (a = t("img[usemap='#" + n + "']")).length > 0 && a.is(":visible")) : (/^(input|select|textarea|button|object)$/.test(l) ? (o = !e.disabled) && (r = t(e).closest("fieldset")[0]) && (o = !r.disabled) : (o = ("a" === l && e.href) || i), o && t(e).is(":visible") && "visible" === t(e).css("visibility"));
		}),
		t.extend(t.expr.pseudos, {
		...
		(t.fn.labels = function () {
			var t, e, i, s, n;
			return this.length ? (this[0].labels && this[0].labels.length ? this.pushStack(this[0].labels) : ((s = this.eq(0).parents("label")), (i = this.attr("id")) && ((n = (t = this.eq(0).parents().last()).add(t.length ? t.siblings() : this.siblings())), (e = "label[for='" + CSS.escape(i) + "']"), (s = s.add(n.find(e).addBack(e)))), this.pushStack(s))) : this.pushStack([]);
		}),
	...
	t(document).on("mouseup", function () {
		...
		t.widget("ui.draggable", t.ui.mouse, {
			...
			_setContainment: function () {
				...
				if ("document" === n.containment) {
					this.containment = [0, 0, t(a).width() - this.helperProportions.width - this.margins.left, (t(a).height() || a.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top];
					return;
				}
			...
			stop: function (e, i, s) {
				...
				(s.cancelHelperRemoval = !1),
					t.each(s.sortables, function () {
						this.isOver ? ((this.isOver = 0), (s.cancelHelperRemoval = !0), (this.cancelHelperRemoval = !1), (this._storedCSS = { position: this.placeholder.css("position"), top: this.placeholder.css("top"), left: this.placeholder.css("left") }), this._mouseStop(e), (this.options.helper = this.options._helper)) : ((this.cancelHelperRemoval = !0), this._trigger("deactivate", e, n));
					});
			},
			drag: function (e, i, s) {
				t.each(s.sortables, function () {
		...
		t.ui.plugin.add("draggable", "snap", {
			...
			drag: function (e, i, s) {
				...
				for (d = s.snapElements.length - 1; d >= 0; d--) {
					if (((h = (l = s.snapElements[d].left - s.margins.left) + s.snapElements[d].width), (c = (u = s.snapElements[d].top - s.margins.top) + s.snapElements[d].height), _ < l - g || m > h + g || b < u - g || v > c + g || !t.contains(s.snapElements[d].item.ownerDocument, s.snapElements[d].item))) {
		...
		t.widget("ui.resizable", t.ui.mouse, {
			...
			_hasScroll: function (e, i) {
				...
				if ("scroll" === a || e[(s = i && "left" === i ? "scrollLeft" : "scrollTop")] > 0) return !0;
				try {
					(e[s] = 1), (n = e[s] > 0), (e[s] = 0);
				} catch (t) {}
				return n;
			...
			_create: function () {
				...
				this._addClass("ui-resizable"),
					...
					this.element[0].nodeName.match(/^(canvas|textarea|input|select|button|img)$/i) && (this.element.wrap(t("<div class='ui-wrapper'></div>").css({ overflow: "hidden", position: this.element.css("position"), width: this.element.outerWidth(), height: this.element.outerHeight(), top: this.element.css("top"), left: this.element.css("left") })), (this.element = this.element.parent().data("ui-resizable", this.element.resizable("instance"))), (this.elementIsWrapper = !0), (e = { marginTop: this.originalElement.css("marginTop"), marginRight: this.originalElement.css("marginRight"), marginBottom: this.originalElement.css("marginBottom"), marginLeft: this.originalElement.css("marginLeft") }), this.element.css(e), (this.originalResizeStyle = this.originalElement.css("resize")), this.originalElement.css("resize", "none"), this._proportionallyResizeElements.push(this.originalElement.css({ position: "static", zoom: 1, display: "block" })), this._proportionallyResize()),
					this._setupHandles(),
					i.autoHide &&
						t(this.element)
			...
			_setupHandles: function () {
				var e,
					...
					o = this.options,
					r = this;
				if (((this.handles = o.handles || (t(".ui-resizable-handle", this.element).length ? { n: ".ui-resizable-n", e: ".ui-resizable-e", s: ".ui-resizable-s", w: ".ui-resizable-w", se: ".ui-resizable-se", sw: ".ui-resizable-sw", ne: ".ui-resizable-ne", nw: ".ui-resizable-nw" } : "e,s,se")), (this._handles = t()), (this._addedHandles = t()), this.handles.constructor === String)) for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), s = this.handles.split(","), this.handles = {}, i = 0; i < s.length; i++) (n = "ui-resizable-" + (e = String.prototype.trim.call(s[i]))), (a = t("<div>")), this._addClass(a, "ui-resizable-handle " + n), a.css({ zIndex: o.zIndex }), (this.handles[e] = ".ui-resizable-" + e), this.element.children(this.handles[e]).length || (this.element.append(a), (this._addedHandles = this._addedHandles.add(a)));
			...
			_calculateAdjustedElementDimensions: function (t) {
				var e,
					...
					s,
					n = t.get(0);
				return "content-box" === t.css("box-sizing") && (this._hasScroll(n) || this._hasScroll(n, "left")) ? ((e = parseFloat(n.style.width)), (i = parseFloat(n.style.height)), (s = this._getPaddingPlusBorderDimensions(t)), (e = isNaN(e) ? this._getElementTheoreticalSize(t, s, "width") : e), { height: (i = isNaN(i) ? this._getElementTheoreticalSize(t, s, "height") : i), width: e }) : { height: parseFloat(t.css("height")), width: parseFloat(t.css("width")) };
			},
				...
				d &&
					...
					/document/.test(c) || c === document
						...
						: ((e = t(d)),
							...
							(l.parentData = { element: d, left: s.left, top: s.top, width: o, height: r })));
			},
			resize: function (e) {
				var i,
					s,
		...
		t.ui.plugin.add("resizable", "alsoResize", {
			start: function () {
				...
				t(e.options.alsoResize).each(function () {
					...
					i.data("ui-resizable-alsoresize", { width: s.width, height: s.height, left: parseFloat(i.css("left")), top: parseFloat(i.css("top")) });
				});
			},
			resize: function (e, i) {
		...
		t.ui.plugin.add("resizable", "ghost", {
			start: function () {
				var e = t(this).resizable("instance"),
					i = e.size;
				(e.ghost = e.originalElement.clone()), e.ghost.css({ opacity: 0.25, display: "block", position: "relative", height: i.height, width: i.width, margin: 0, left: 0, top: 0 }), e._addClass(e.ghost, "ui-resizable-ghost"), !0 === t.uiBackCompat && "string" == typeof e.options.ghost && e.ghost.addClass(this.options.ghost), e.ghost.appendTo(e.helper);
			},
			resize: function () {
				var e = t(this).resizable("instance");
		...
		t.widget("ui.accordion", {
			...
			_eventHandler: function (e) {
				var i,
					...
					h = l ? t() : o.next(),
					u = a.next(),
					c = { oldHeader: a, oldPanel: u, newHeader: l ? t() : o, newPanel: h };
			...
			_animate: function (t, e, i) {
				...
				return ("number" == typeof c && (a = c), "string" == typeof c && (n = c), (n = n || c.easing || u.easing), (a = a || c.duration || u.duration), e.length)
					? t.length
				...
				switch (e.keyCode) {
					...
					default:
						(o = !1),
							...
							(i = a && -1 !== i.index(this.active.next()) ? this.active.nextAll(".ui-menu-item") : i).length || ((n = String.fromCharCode(e.keyCode)), (i = this._filterMenuItems(n))),
							i.length
								? (this.focus(e, i),
				...
				this._toggleClass("ui-menu-icons", null, !!this.element.find(".ui-icon").length),
					(i = r
						...
						.each(function () {
							...
							a._addClass(s, "ui-menu-icon", "ui-icon " + o), i.attr("aria-haspopup", "true").prepend(s), e.attr("aria-labelledby", i.attr("id"));
						})),
				...
				!this.isLastItem() &&
					(this._hasScroll()
						? ((s = this.active.offset().top),
							...
							0 === t.fn.jquery.indexOf("3.2.") && (n += this.element[0].offsetHeight - this.element.outerHeight()),
		...
		t.widget("ui.autocomplete", {
			...
			_create: function () {
				var e,
					...
					a = "textarea" === n,
					o = "input" === n;
				(this.isMultiLine = a || (!o && "true" === this.element.prop("contentEditable"))),
					...
					this._on(this.menu.element, {
						...
						menuselect: function (t, e) {
							var i = e.item.data("ui-autocomplete-item"),
								s = this.previous;
							this.element[0] !== this.document[0].activeElement && (this.element.trigger("focus"), (this.previous = s)), !1 !== this._trigger("select", t, { item: i }) && this._value(i.value), (this.term = this._value()), this.close(t), (this.selectedItem = i);
						},
					}),
	...
	t.widget("ui.controlgroup", {
			...
			t.each(this.options.items, function (s, n) {
				...
				if (n) {
					if ("controlgroupLabel" === s) {
						(a = e.element.find(n)).each(function () {
							var e = t(this);
					...
					t.fn[s] &&
						((o = e["_" + s + "Options"] ? e["_" + s + "Options"]("middle") : { classes: {} }),
						e.element.find(n).each(function () {
							...
							if ("button" !== s || !n.parent(".ui-spinner").length) {
								...
								var l = n[s]("widget");
								t.data(l[0], "ui-controlgroup-data", a || n[s]("instance")), i.push(l[0]);
							}
						}));
				}
			}),
		...
		_resolveClassesValues: function (e, i) {
			...
			return (
				t.each(e, function (t) {
					...
					(n = String.prototype.trim.call(n.replace(r, ""))), (s[t] = (n + " " + e[t]).replace(/\s+/g, " "));
				}),
				s
			);
		},
						...
						i
							? this.length || "instance" !== e
								? this.each(function () {
										var i,
											a = t(this).attr("type"),
											o = t.data(this, "ui-" + ("checkbox" !== a && "radio" !== a ? "button" : "checkboxradio"));
										return "instance" === e ? ((n = o), !1) : o ? ("function" != typeof o[e] || "_" === e.charAt(0) ? t.error("no such method '" + e + "' for button widget instance") : (i = o[e].apply(o, s)) !== o && void 0 !== i ? ((n = i && i.jquery ? n.pushStack(i.get()) : i), !1) : void 0) : t.error("cannot call methods on button prior to initialization; attempted to call method '" + e + "'");
									})
								: (n = void 0)
							: (s.length && (e = t.widget.extend.apply(null, [e].concat(s))),
								this.each(function () {
									var i = t(this).attr("type"),
										s = "checkbox" !== i && "radio" !== i ? "button" : "checkboxradio",
										n = t.data(this, "ui-" + s);
		...
		t.extend(l.prototype, {
			...
			_newInst: function (e, i) {
				return { id: e[0].id.replace(/([^A-Za-z0-9_\-])/g, "\\\\$1"), input: e, selectedDay: 0, selectedMonth: 0, selectedYear: 0, drawMonth: 0, drawYear: 0, inline: i, dpDiv: i ? h(t("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>")) : this.dpDiv };
			},
			...
			_attachments: function (e, i) {
				...
				i.append && i.append.remove(),
					o && ((i.append = t("<span>").addClass(this._appendClass).text(o)), e[r ? "before" : "after"](i.append)),
					...
					("button" === s || "both" === s) &&
						...
						this._get(i, "buttonImageOnly") ? (i.trigger = t("<img>").addClass(this._triggerClass).attr({ src: a, alt: n, title: n })) : ((i.trigger = t("<button type='button'>").addClass(this._triggerClass)), a ? i.trigger.html(t("<img>").attr({ src: a, alt: n, title: n })) : i.trigger.text(n)),
			...
			_dialogDatepicker: function (e, i, s, n, a) {
				var o,
					...
					u,
					d = this._dialogInst;
				return d || ((this.uuid += 1), (o = "dp" + this.uuid), (this._dialogInput = t("<input type='text' id='" + o + "' style='position: absolute; top: -100px; width: 0px;'/>")), this._dialogInput.on("keydown", this._doKeyDown), t("body").append(this._dialogInput), ((d = this._dialogInst = this._newInst(this._dialogInput, !1)).settings = {}), t.data(this._dialogInput[0], "datepicker", d)), c(d.settings, n || {}), (i = i && i.constructor === Date ? this._formatDate(d, i) : i), this._dialogInput.val(i), (this._pos = a ? (a.length ? a : [a.pageX, a.pageY]) : null), this._pos || ((r = document.documentElement.clientWidth), (l = document.documentElement.clientHeight), (h = document.documentElement.scrollLeft || document.body.scrollLeft), (u = document.documentElement.scrollTop || document.body.scrollTop), (this._pos = [r / 2 - 100 + h, l / 2 - 150 + u])), this._dialogInput.css("left", this._pos[0] + 20 + "px").css("top", this._pos[1] + "px"), (d.settings.onSelect = s), (this._inDialog = !0), this.dpDiv.addClass(this._dialogClass), this._showDatepicker(this._dialogInput[0]), t.blockUI && t.blockUI(this.dpDiv), t.data(this._dialogInput[0], "datepicker", d), this;
			},
			_destroyDatepicker: function (e) {
				var i,
					s = t(e),
					n = t.data(e, "datepicker");
				s.hasClass(this.markerClassName) && ((i = e.nodeName.toLowerCase()), t.removeData(e, "datepicker"), "input" === i ? (n.append.remove(), n.trigger.remove(), s.removeClass(this.markerClassName).off("focus", this._showDatepicker).off("keydown", this._doKeyDown).off("keypress", this._doKeyPress).off("keyup", this._doKeyUp)) : ("div" === i || "span" === i) && s.removeClass(this.markerClassName).empty(), t.datepicker._hideDatepicker(), v === n && ((v = null), (this._curInst = null)));
			},
				...
				if (("input" !== (e = e.target || e).nodeName.toLowerCase() && (e = t("input", e.parentNode)[0]), !t.datepicker._isDisabledDatepicker(e) && t.datepicker._lastInput !== e))
					(i = t.datepicker._getInst(e)),
						...
						!1 !== (n = (s = t.datepicker._get(i, "beforeShow")) ? s.apply(e, [e, i]) : {}) &&
							...
							i.dpDiv.css({ position: t.datepicker._inDialog && t.blockUI ? "static" : a ? "fixed" : "absolute", display: "none", left: o.left + "px", top: o.top + "px" }),
							i.inline ||
								...
								i.dpDiv.css(
									...
									(function (t) {
										...
										while (t.length && t[0] !== document) {
											if (("absolute" === (e = t.css("position")) || "relative" === e || "fixed" === e) && !isNaN((i = parseInt(t.css("zIndex"), 10))) && 0 !== i) return i;
											t = t.parent();
										}
										return 0;
									})(t(e)) + 1,
			...
			_updateDatepicker: function (e) {
				...
				var i,
					...
					o = t.datepicker._get(e, "onUpdateDatepicker");
				a.length > 0 && u.apply(a.get(0)),
					...
					o && o.apply(e.input ? e.input[0] : null, [e]);
			},
			...
			_findPos: function (e) {
				var i,
					s = this._getInst(e),
					n = this._get(s, "isRTL");
				while (e && ("hidden" === e.type || 1 !== e.nodeType || t.expr.pseudos.hidden(e))) e = e[n ? "previousSibling" : "nextSibling"];
			...
			_hideDatepicker: function (e) {
				...
				o &&
					...
					t.effects && t.effects.effect[i] ? o.dpDiv.hide(i, t.datepicker._get(o, "showOptions"), s, n) : o.dpDiv["slideDown" === i ? "slideUp" : "fadeIn" === i ? "fadeOut" : "hide"](i ? s : null, n),
					i || n(),
			...
			_adjustDate: function (e, i, s) {
				var n = t(e),
					a = this._getInst(n[0]);
				!this._isDisabledDatepicker(n[0]) && (this._adjustInstDate(a, i, s), this._updateDatepicker(a));
			},
			_gotoToday: function (e) {
				var i,
					s = t(e),
					n = this._getInst(s[0]);
				this._get(n, "gotoCurrent") && n.currentDay ? ((n.selectedDay = n.currentDay), (n.drawMonth = n.selectedMonth = n.currentMonth), (n.drawYear = n.selectedYear = n.currentYear)) : ((n.selectedDay = (i = new Date()).getDate()), (n.drawMonth = n.selectedMonth = i.getMonth()), (n.drawYear = n.selectedYear = i.getFullYear())), this._notifyChange(n), this._adjustDate(s);
			},
			...
			_selectDay: function (e, i, s, n) {
				var a,
					o = t(e);
				!(t(n).hasClass(this._unselectableClass) || this._isDisabledDatepicker(o[0])) && (((a = this._getInst(o[0])).selectedDay = a.currentDay = parseInt(t("a", n).attr("data-date"))), (a.selectedMonth = a.currentMonth = i), (a.selectedYear = a.currentYear = s), this._selectDate(e, this._formatDate(a, a.currentDay, a.currentMonth, a.currentYear)));
			},
			...
			_selectDate: function (e, i) {
				var s,
					n = t(e),
					a = this._getInst(n[0]);
				(i = null != i ? i : this._formatDate(a)), a.input && a.input.val(i), this._updateAlternate(a), (s = this._get(a, "onSelect")) ? s.apply(a.input ? a.input[0] : null, [i, a]) : a.input && a.input.trigger("change"), a.inline ? this._updateDatepicker(a) : (this._hideDatepicker(), (this._lastInput = a.input[0]), "object" != typeof a.input[0] && a.input.trigger("focus"), (this._lastInput = null));
			},
			_updateAlternate: function (e) {
				...
				a && ((i = this._get(e, "altFormat") || this._get(e, "dateFormat")), (s = this._getDate(e)), (n = this.formatDate(i, s, this._getFormatConfig(e))), t(document).find(a).val(n));
			},
			...
			parseDate: function (e, i, s) {
					...
					k = function (e, s, n) {
						...
						if (
							(t.each(o, function (t, e) {
								var s = e[1];
								if (i.substr(l, s.length).toLowerCase() === s.toLowerCase()) return (a = e[0]), (l += s.length), !1;
							}),
							-1 !== a)
						)
							return a + 1;
				...
				if ((-1 === g ? (g = new Date().getFullYear()) : g < 100 && (g += new Date().getFullYear() - (new Date().getFullYear() % 100) + (g <= u ? 0 : -100)), v > -1)) {
					(m = 1), (_ = v);
					do {
			...
			_generateHTML: function (e) {
				var i,
					...
					te = e.drawYear;
				if ((tt < 0 && ((tt += 12), te--), Z)) {
					(i = this._daylightSavingAdjust(new Date(Z.getFullYear(), Z.getMonth() - V[0] * V[1] + 1, Z.getDate()))), (i = Q && i < Q ? Q : i);
				...
				for (
					e.drawMonth = tt,
						...
						s = U ? this.formatDate(s, this._daylightSavingAdjust(new Date(te, tt - X, 1)), this._getFormatConfig(e)) : s,
						n = this._canAdjustMonth(e, -1, te, tt)
							? t("<a>")
									.attr({ class: "ui-datepicker-prev ui-corner-all", "data-handler": "prev", "data-event": "click", title: s })
									.append(
										t("<span>")
						...
						a = U ? this.formatDate(a, this._daylightSavingAdjust(new Date(te, tt + X, 1)), this._getFormatConfig(e)) : a,
						o = this._canAdjustMonth(e, 1, te, tt)
							? t("<a>")
									.attr({ class: "ui-datepicker-next ui-corner-all", "data-handler": "next", "data-event": "click", title: a })
									.append(
										t("<span>")
							...
							: K
								? ""
								: t("<a>")
										.attr({ class: "ui-datepicker-next ui-corner-all ui-state-disabled", title: a })
										.append(
											t("<span>")
						...
						l = this._get(e, "gotoCurrent") && e.currentDay ? J : B,
						r = U ? this.formatDate(r, l, this._getFormatConfig(e)) : r,
						h = "",
						e.inline || (h = t("<button>").attr({ type: "button", class: "ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all", "data-handler": "hide", "data-event": "click" }).text(this._get(e, "closeText"))[0].outerHTML),
						u = "",
						q &&
							(u = t("<div class='ui-datepicker-buttonpane ui-widget-content'>")
								.append(j ? h : "")
								.append(this._isInRange(e, l) ? t("<button>").attr({ type: "button", class: "ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all", "data-handler": "today", "data-event": "click" }).text(r) : "")
								.append(j ? "" : h)[0].outerHTML),
						c = isNaN((c = parseInt(this._get(e, "firstDay"), 10))) ? 0 : c,
					...
					for (C = 0, D = "", this.maxRows = 4; C < V[1]; C++) {
						if (((T = this._daylightSavingAdjust(new Date(te, tt, e.selectedDay))), (M = " ui-corner-all"), (I = ""), $)) {
						...
						for (I += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + M + "'>" + (/all|left/.test(M) && 0 === x ? (j ? o : n) : "") + (/all|right/.test(M) && 0 === x ? (j ? n : o) : "") + this._generateMonthYearHeader(e, tt, te, Q, Z, x > 0 || C > 0, g, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>", S = d ? "<th class='ui-datepicker-week-col'>" + this._get(e, "weekHeader") + "</th>" : "", k = 0; k < 7; k++) (P = (k + c) % 7), (S += "<th scope='col'" + ((k + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + p[P] + "'>" + f[P] + "</span></th>");
						for (I += S + "</tr></thead><tbody>", z = this._getDaysInMonth(te, tt), te === e.selectedYear && tt === e.selectedMonth && (e.selectedDay = Math.min(e.selectedDay, z)), O = Math.ceil(((H = (this._getFirstDayOfMonth(te, tt) - c + 7) % 7) + z) / 7), A = $ && this.maxRows > O ? this.maxRows : O, this.maxRows = A, E = this._daylightSavingAdjust(new Date(te, tt, 1 - H)), N = 0; N < A; N++) {
							for (I += "<tr>", W = d ? "<td class='ui-datepicker-week-col'>" + this._get(e, "calculateWeek")(E) + "</td>" : "", k = 0; k < 7; k++) (F = _ ? _.apply(e.input ? e.input[0] : null, [E]) : [!0, ""]), (L = ((R = E.getMonth() !== tt) && !b) || !F[0] || (Q && E < Q) || (Z && E > Z)), (W += "<td class='" + ((k + c + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (R ? " ui-datepicker-other-month" : "") + ((E.getTime() === T.getTime() && tt === e.selectedMonth && e._keyEvent) || (y.getTime() === E.getTime() && y.getTime() === T.getTime()) ? " " + this._dayOverClass : "") + (L ? " " + this._unselectableClass + " ui-state-disabled" : "") + (R && !v ? "" : " " + F[1] + (E.getTime() === J.getTime() ? " " + this._currentClass : "") + (E.getTime() === B.getTime() ? " ui-datepicker-today" : "")) + "'" + ((!R || v) && F[2] ? " title='" + F[2].replace(/'/g, "&#39;") + "'" : "") + (L ? "" : " data-handler='selectDay' data-event='click' data-month='" + E.getMonth() + "' data-year='" + E.getFullYear() + "'") + ">" + (R && !v ? "&#xa0;" : L ? "<span class='ui-state-default'>" + E.getDate() + "</span>" : "<a class='ui-state-default" + (E.getTime() === B.getTime() ? " ui-state-highlight" : "") + (E.getTime() === J.getTime() ? " ui-state-active" : "") + (R ? " ui-priority-secondary" : "") + "' href='#' aria-current='" + (E.getTime() === J.getTime() ? "true" : "false") + "' data-date='" + E.getDate() + "'>" + E.getDate() + "</a>") + "</td>"), E.setDate(E.getDate() + 1), (E = this._daylightSavingAdjust(E));
							I += W + "</tr>";
						}
						++tt > 11 && ((tt = 0), te++), (I += "</tbody></table>" + ($ ? "</div>" + (V[0] > 0 && C === V[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")), (D += I);
					}
					w += D;
				}
			...
			_generateMonthYearHeader: function (t, e, i, s, n, a, o, r) {
				var l,
					...
					k = "";
				if (a || !m) k += "<span class='ui-datepicker-month'>" + o[e] + "</span>";
				else {
					for (l = s && s.getFullYear() === i, h = n && n.getFullYear() === i, k += "<select class='ui-datepicker-month' aria-label='" + b + "' data-handler='selectMonth' data-event='change'>", u = 0; u < 12; u++) (!l || u >= s.getMonth()) && (!h || u <= n.getMonth()) && (k += "<option value='" + u + "'" + (u === e ? " selected='selected'" : "") + ">" + r[u] + "</option>");
					k += "</select>";
				}
				if ((v || (w += k + (a || !(m && _) ? "&#xa0;" : "")), !t.yearshtml)) {
					if (((t.yearshtml = ""), a || !_)) w += "<span class='ui-datepicker-year'>" + i + "</span>";
					else {
						for (
				...
				return (w += this._get(t, "yearSuffix")), v && (w += (a || !(m && _) ? "&#xa0;" : "") + k), (w += "</div>");
			},
		...
		t.widget("ui.dialog", {
			...
			close: function (e) {
				...
				this._isOpen &&
					...
					this.opener.filter(":focusable").trigger("focus").length || t(this.document[0].activeElement).trigger("blur"),
			...
			_createTitlebar: function () {
				...
				(this.uiDialogTitlebar = t("<div>")),
					...
					(e = t("<" + (Number.isInteger(this.options.uiDialogTitleHeadingLevel) && this.options.uiDialogTitleHeadingLevel > 0 && this.options.uiDialogTitleHeadingLevel <= 6 ? "h" + this.options.uiDialogTitleHeadingLevel : "span") + ">")
						.uniqueId()
			...
			_createButtons: function () {
				...
				t.each(i, function (i, s) {
					...
					(s = "function" == typeof s ? { click: s, text: i } : s),
						...
						(a = { icon: s.icon, iconPosition: s.iconPosition, showLabel: s.showLabel, icons: s.icons, text: s.text }),
						delete s.click,
						delete s.icon,
			...
			_makeDraggable: function () {
				...
				this.uiDialog.draggable({
					...
					stop: function (n, a) {
						var o = a.offset.left - e.document.scrollLeft(),
							r = a.offset.top - e.document.scrollTop();
						(i.position = { my: "left top", at: "left" + (o >= 0 ? "+" : "") + o + " top" + (r >= 0 ? "+" : "") + r, of: e.window }), e._removeClass(t(this), "ui-dialog-dragging"), e._unblockFrames(), e._trigger("dragStop", n, s(a));
					},
				});
			},
			...
			_setOption: function (e, i) {
				...
				"disabled" !== e &&
					...
					"draggable" === e && ((s = a.is(":data(ui-draggable)")) && !i && a.draggable("destroy"), !s && i && this._makeDraggable()),
					"position" === e && this._position(),
					"resizable" !== e || ((n = a.is(":data(ui-resizable)")) && !i && a.resizable("destroy"), n && "string" == typeof i && a.resizable("option", "handles", i), n || !1 === i || this._makeResizable()),
					"title" === e && this._title(this.uiDialogTitlebar.find(".ui-dialog-title")),
					"modal" === e && a.attr("aria-modal", i ? "true" : null));
			},
			_size: function () {
				var t,
					e,
		...
		t.widget("ui.selectmenu", [
			t.ui.formResetMixin,
			{
				...
				_renderItem: function (e, i) {
					...
					return i.disabled && this._addClass(s, null, "ui-state-disabled"), i.hidden ? s.prop("hidden", !0) : this._setText(n, i.label), s.append(n).appendTo(e);
				},
				...
				_documentClick: {
					mousedown: function (e) {
						this.isOpen && (t(e.target).closest(".ui-selectmenu-menu, #" + CSS.escape(this.ids.button)).length || this.close(e));
					},
				},
				_buttonEvents: {
					mousedown: function () {
				...
				_parseOption: function (t, e) {
					...
					return { element: t, index: e, value: t.val(), label: t.text(), hidden: i.prop("hidden") || t.prop("hidden"), optgroup: i.attr("label") || "", disabled: i.prop("disabled") || t.prop("disabled") };
				},
				_destroy: function () {
		...
		t.widget("ui.slider", t.ui.mouse, {
			...
			_createHandles: function () {
				var e,
					...
					a = [];
				for (i = (s.values && s.values.length) || 1, n.length > i && (n.slice(i).remove(), (n = n.slice(0, i))), e = n.length; e < i; e++) a.push("<span tabindex='0'></span>");
			...
			_mouseCapture: function (e) {
				...
				return (
					...
					!1 !== this._start(e, o) && ((this._mouseSliding = !0), (this._handleIndex = o), this._addClass(a, null, "ui-state-active"), a.trigger("focus"), (r = a.offset()), (l = !t(e.target).parents().addBack().is(".ui-slider-handle")), (this._clickOffset = l ? { left: 0, top: 0 } : { left: e.pageX - r.left - a.width() / 2, top: e.pageY - r.top - a.height() / 2 - (parseInt(a.css("borderTopWidth"), 10) || 0) - (parseInt(a.css("borderBottomWidth"), 10) || 0) + (parseInt(a.css("marginTop"), 10) || 0) }), this.handles.hasClass("ui-state-hover") || this._slide(e, o, s), (this._animateOff = !0), !0))
				);
			},
			_mouseStart: function () {
				return !0;
			...
			_slide: function (t, e, i) {
				var s,
					n = this.value(),
					a = this.values();
				this._hasMultipleValues() && ((s = this.values(+!e)), (n = this.values(e)), 2 === this.options.values.length && !0 === this.options.range && (i = 0 === e ? Math.min(s, i) : Math.max(s, i)), (a[e] = i)), i !== n && !1 !== this._trigger("slide", t, this._uiHash(e, i, a)) && (this._hasMultipleValues() ? this.values(e, i) : this.value(i));
			},
			_stop: function (t, e) {
			...
			_refreshValue: function () {
				...
				this._hasMultipleValues()
					? this.handles.each(function (s) {
							(i = ((l.values(s) - l._valueMin()) / (l._valueMax() - l._valueMin())) * 100), (u["horizontal" === l.orientation ? "left" : "bottom"] = i + "%"), t(this).stop(1, 1)[h ? "animate" : "css"](u, r.animate), !0 === l.options.range && ("horizontal" === l.orientation ? (0 === s && l.range.stop(1, 1)[h ? "animate" : "css"]({ left: i + "%" }, r.animate), 1 === s && l.range[h ? "animate" : "css"]({ width: i - e + "%" }, { queue: !1, duration: r.animate })) : (0 === s && l.range.stop(1, 1)[h ? "animate" : "css"]({ bottom: i + "%" }, r.animate), 1 === s && l.range[h ? "animate" : "css"]({ height: i - e + "%" }, { queue: !1, duration: r.animate }))), (e = i);
						})
					: ((s = this.value()), (n = this._valueMin()), (i = (a = this._valueMax()) !== n ? ((s - n) / (a - n)) * 100 : 0), (u["horizontal" === this.orientation ? "left" : "bottom"] = i + "%"), this.handle.stop(1, 1)[h ? "animate" : "css"](u, r.animate), "min" === o && "horizontal" === this.orientation && this.range.stop(1, 1)[h ? "animate" : "css"]({ width: i + "%" }, r.animate), "max" === o && "horizontal" === this.orientation && this.range.stop(1, 1)[h ? "animate" : "css"]({ width: 100 - i + "%" }, r.animate), "min" === o && "vertical" === this.orientation && this.range.stop(1, 1)[h ? "animate" : "css"]({ height: i + "%" }, r.animate), "max" === o && "vertical" === this.orientation && this.range.stop(1, 1)[h ? "animate" : "css"]({ height: 100 - i + "%" }, r.animate));
			},
			_handleEvents: {
				keydown: function (e) {
					var i,
					...
					switch (((n = this.options.step), (i = s = this._hasMultipleValues() ? this.values(a) : this.value()), e.keyCode)) {
						case t.ui.keyCode.HOME:
							s = this._valueMin();
							break;
						case t.ui.keyCode.END:
		...
		t.widget("ui.tabs", {
			...
			_findNextTab: function (e, i) {
				...
				while (-1 !== t.inArray((e > s && (e = 0), e < 0 && (e = s), e), this.options.disabled)) e = i ? e + 1 : e - 1;
				return e;
			},
			...
			_processTabs: function () {
				...
				(this.tablist = this._getList().attr("role", "tablist")),
					...
					this.anchors.each(function (i, s) {
						...
						e._isLocal(s) ? ((o = (n = decodeURIComponent(s.hash)).substring(1)), (a = e.element.find("#" + CSS.escape(o)))) : ((n = "#" + (o = l.attr("aria-controls") || t({}).uniqueId()[0].id)), (a = e.element.find(n)).length || (a = e._createPanel(o)).insertAfter(e.panels[i - 1] || e.tablist), a.attr("aria-live", "polite")), a.length && (e.panels = e.panels.add(a)), h && l.data("ui-tabs-aria-controls", h), l.attr({ "aria-controls": o, "aria-labelledby": r }), a.attr("aria-labelledby", r);
					}),
			...
			_eventHandler: function (e) {
				var i = this.options,
					...
					h = { oldTab: s, oldPanel: l, newTab: o ? t() : n, newPanel: r };
			...
			_toggle: function (e, i) {
				...
				function r() {
					s._addClass(i.newTab.closest("li"), "ui-tabs-active", "ui-state-active"), n.length && s.options.show ? s._show(n, s.options.show, o) : (n.show(), o());
				}
				(this.running = !0),
					a.length && this.options.hide
						...
						: (this._removeClass(i.oldTab.closest("li"), "ui-tabs-active", "ui-state-active"), a.hide(), r()),
			...
			_getIndex: function (t) {
				return "string" == typeof t && (t = this.anchors.index(this.anchors.filter("[href$='" + CSS.escape(t) + "']"))), t;
			},
			_destroy: function () {
		...
		t.widget("ui.tooltip", {
			...
			_removeDescribedBy: function (e) {
				var i = e.data("ui-tooltip-id"),
					...
					n = t.inArray(i, s);
				-1 !== n && s.splice(n, 1), e.removeData("ui-tooltip-id"), (s = String.prototype.trim.call(s.join(" "))) ? e.attr("aria-describedby", s) : e.removeAttr("aria-describedby");
			},
			_create: function () {
			...
			_updateContent: function (t, e) {
				...
				(i = s.call(t[0], function (i) {
					t.data("ui-tooltip-open") && (e && (e.type = a), n._open(e, t, i));
				})) && this._open(e, t, i);
			},
			_open: function (e, i, s) {
				...
				if (s) {
					...
					i.is("[title]") && (e && "mouseover" === e.type ? i.attr("title", "") : i.removeAttr("title")),
						(a = (n = this._tooltip(i)).tooltip),
						this._addDescribedBy(i, a.attr("id")),
						a.find(".ui-tooltip-content").html(s),
						this.liveRegion.children().hide(),
						(r = t("<div>").html(a.find(".ui-tooltip-content").html())).removeAttr("name").find("[name]").removeAttr("name"),
						r.removeAttr("id").find("[id]").removeAttr("id"),
						r.appendTo(this.liveRegion),
						this.options.track && e && /^mouse/.test(e.type) ? (this._on(this.document, { mousemove: h }), h(e)) : a.position(t.extend({ of: i }, this.options.position)),
						a.hide(),
						...
						this.options.track &&
							...
							(o = this.delayedShow =
								setInterval(function () {
									a.is(":visible") && (h(l.of), clearInterval(o));
								}, 13)),
	...
	function P(e) {
		...
		M(x, function (t, n) {
			var a,
				...
				r = o && n.parse(o),
				l = n.space || "rgba";
			if (r) return (a = i[l](r)), (i[C[l].cache] = a[C[l].cache]), (s = i._rgba = a._rgba), !1;
		}),
		s.length)
	...
	M(C, function (t, e) {
		...
		(D.fn = t.extend(D.prototype, {
			parse: function (e, i, s, n) {
				...
				var a = this,
					o = I(e),
					r = (this._rgba = []);
				return (void 0 !== i && ((e = [e, i, s, n]), (o = "array")), "string" === o)
					? this.parse(P(e) || b._default)
					: "array" === o
						? (M(C.rgba.props, function (t, i) {
								r[i.idx] = S(e[i.idx], i);
							}),
							this)
						: "object" === o
							? (e instanceof D
									...
									: M(C, function (i, s) {
											...
											M(s.props, function (t, i) {
												...
												a[n] && 0 > t.inArray(null, a[n].slice(0, 3)) && (null == a[n][3] && (a[n][3] = 1), s.from && (a._rgba = s.from(a[n])));
										}),
								this)
							: void 0;
			},
			...
			transition: function (t, e) {
				...
				return (
					(i = i[n.cache]),
					M(n.props, function (t, s) {
						var n = s.idx,
							a = o[n],
							l = i[n],
							h = T[s.type] || {};
						null !== l && (null === a ? (r[n] = l) : (h.mod && (l - a > h.mod / 2 ? (a += h.mod) : a - l > h.mod / 2 && (a -= h.mod)), (r[n] = S((l - a) * e + a, s))));
					}),
					this[s](r)
				);
			},
		...
		(C.hsla.to = function (t) {
			...
			var e,
				...
				h = o + r,
				u = 0.5 * h;
			return [Math.round(r === o ? 0 : i === o ? (60 * (s - n)) / l + 360 : s === o ? (60 * (n - i)) / l + 120 : (60 * (i - s)) / l + 240) % 360, 0 === l ? 0 : u <= 0.5 ? l / h : l / (2 - h), u, null == a ? 1 : a];
		}),
		(C.hsla.from = function (t) {
			...
			var e = t[0] / 360,
				...
				o = 2 * s - a;
			return [Math.round(255 * z(o, a, e + 1 / 3)), Math.round(255 * z(o, a, e)), Math.round(255 * z(o, a, e - 1 / 3)), n];
		}),
		M(C, function (t, e) {
			var i = e.props,
				s = e.cache,
			...
			(D.fn[t] = function (t) {
				...
				var e,
					o = I(t),
					r = "array" === o || "object" === o ? t : arguments,
					l = this[s].slice();
				return (M(i, function (t, e) {
					var i = r["object" === o ? t : e.idx];
					null == i && (i = l[e.idx]), (l[e.idx] = S(i, e));
				}),
				a)
					? (((e = D(a(l)))[s] = l), e)
					: D(l);
					...
					!D.fn[e] &&
						(D.fn[e] = function (s) {
							var n,
								...
								r,
								l = I(s);
							return ((a = (n = this[(r = "alpha" === e ? (this._hsla ? "hsla" : "rgba") : t)]())[i.idx]), "undefined" === l) ? a : ("function" === l && (l = I((s = s.call(this, a)))), null == s && i.empty) ? this : ("string" === l && (o = k.exec(s)) && (s = a + parseFloat(o[2]) * ("+" === o[1] ? 1 : -1)), (n[i.idx] = s), this[r](n));
						});
				});
		}),
		(D.hook = function (e) {
			M(e.split(" "), function (e, i) {
				(t.cssHooks[i] = {
					set: function (t, e) {
						var s;
						"transparent" !== e && ("string" !== I(e) || (s = P(e))) && (e = (e = D(s || e)).toRgbaString()), (t.style[i] = e);
					},
				}),
		...
		D.hook("backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor"),
		...
		(b = t.Color.names = { aqua: "#00ffff", black: "#000000", blue: "#0000ff", fuchsia: "#ff00ff", gray: "#808080", green: "#008000", lime: "#00ff00", maroon: "#800000", navy: "#000080", olive: "#808000", purple: "#800080", red: "#ff0000", silver: "#c0c0c0", teal: "#008080", white: "#ffffff", yellow: "#ffff00", transparent: [null, null, null, 0], _default: "#ffffff" });
	var H = "ui-effects-",
		O = "ui-effects-style",
	...
	(t.effects = { effect: {} }),
		(function () {
			...
			t.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function (e, i) {
				t.fx.step[i] = function (e) {
					(("none" === e.end || e.setAttr) && (1 !== e.pos || e.setAttr)) || (t.style(e.elem, i, e.end), (e.setAttr = !0));
				};
			}),
				...
				t.fn.extend({
					...
					removeClass:
						((i = t.fn.removeClass),
						function (e, s, n, a) {
							return arguments.length > 1 ? t.effects.animateClass.call(this, { remove: e }, s, n, a) : i.apply(this, arguments);
						}),
					toggleClass:
						((s = t.fn.toggleClass),
						function (e, i, n, a, o) {
							return "boolean" != typeof i && void 0 !== i ? t.effects.animateClass.call(this, { toggle: e }, i, n, a) : n ? t.effects.animateClass.call(this, i ? { add: e } : { remove: e }, n, a, o) : s.apply(this, arguments);
						}),
			...
			t.expr &&
				...
				t.fn.extend({
					effect: function () {
						var e = a.apply(this, arguments),
							...
							u = function (e) {
								...
								i.data(A, !0), h.push(n), s && ("show" === n || (n === s && "hide" === n)) && i.show(), (s && "none" === n) || t.effects.saveStyle(i), "function" == typeof e && e();
							};
						if (t.fx.off || !i)
							return l
								? this[l](e.duration, r)
						...
						function c(n) {
							var a = t(this);
							function o() {
								"function" == typeof r && r.call(a[0]), "function" == typeof n && n();
							}
							(e.mode = h.shift()),
								!0 !== t.uiBackCompat || s
									? "none" === e.mode
										...
										: i.call(a[0], e, function () {
												a.removeData(A), t.effects.cleanUp(a), "hide" === e.mode && a.hide(), o();
											})
									: (a.is(":hidden") ? "hide" === l : "show" === l)
										? (a[l](), o())
										: i.call(a[0], e, o);
						}
						return !1 === n ? this.each(u).each(c) : this.queue(o, u).queue(o, c);
					},
					show:
						((i = t.fn.show),
						function (t) {
					...
					toggle:
						((n = t.fn.toggle),
						function (t) {
							if (o(t) || "boolean" == typeof t) return n.apply(this, arguments);
							var e = a.apply(this, arguments);
					...
					transfer: function (e, i) {
						...
						d.appendTo("body")
							...
							.css({ top: c.top - r, left: c.left - l, height: s.innerHeight(), width: s.innerWidth(), position: a ? "fixed" : "absolute" })
				...
				(t.fx.step.clip = function (e) {
					e.clipInit || ((e.start = t(e.elem).cssClip()), "string" == typeof e.end && (e.end = r(e.end, e.elem)), (e.clipInit = !0)), t(e.elem).cssClip({ top: e.pos * (e.end.top - e.start.top) + e.start.top, right: e.pos * (e.end.right - e.start.right) + e.start.right, bottom: e.pos * (e.end.bottom - e.start.bottom) + e.start.bottom, left: e.pos * (e.end.left - e.start.left) + e.start.left });
				});
		})(),
		(e = {}),
	...
	t.effects.define("blind", "hide", function (e, i) {
		...
		t.effects.define("bounce", function (e, i) {
			...
			for (
				...
				((s = {})[m] = (_ ? "-=" : "+=") + c), o.animate(s, f, g).animate(n, f, g), (c = l ? 2 * c : c / 2);
			l && (((s = { opacity: 0 })[m] = (_ ? "-=" : "+=") + c), o.animate(s, f, g)), o.queue(i), t.effects.unshift(o, b, p + 1);
		}),
		...
		t.effects.define("drop", "hide", function (e, i) {
			var s,
				...
				l = "up" === o || "left" === o ? "-=" : "+=",
				h = { opacity: 0 };
			t.effects.createPlaceholder(n), (s = e.distance || n["top" === r ? "outerHeight" : "outerWidth"](!0) / 2), (h[r] = l + s), "show" === a && (n.css(h), (h[r] = ("+=" === l ? "-=" : "+=") + s), (h.opacity = 1)), n.animate(h, { queue: !1, duration: e.duration, easing: e.easing, complete: i });
		}),
		t.effects.define("explode", "hide", function (e, i) {
			var s,
				...
				f = Math.ceil(u.outerHeight() / h),
				g = [];
			function m() {
				g.push(this), g.length === h * h && (u.css({ visibility: "visible" }), t(g).remove(), i());
			}
			for (s = 0; s < h; s++)
				for (n = 0, o = d.top + s * f, l = s - (h - 1) / 2; n < h; n++)
					(a = d.left + n * p),
						(r = n - (h - 1) / 2),
						u
							.clone()
							...
							.css({ position: "absolute", overflow: "hidden", width: p, height: f, left: a + (c ? r * p : 0), top: o + (c ? l * f : 0), opacity: +!c })
							.animate({ left: a + (c ? 0 : r * p), top: o + (c ? 0 : l * f), opacity: +!!c }, e.duration || 500, e.easing, m);
		}),
		t.effects.define("fade", "toggle", function (e, i) {
			var s = "show" === e.mode;
			t(this).css("opacity", +!s).animate({ opacity: +!!s }, { queue: !1, duration: e.duration, easing: e.easing, complete: i });
		}),
		t.effects.define("fold", "hide", function (e, i) {
			var s = t(this),
				...
				p = [u[r[0]], u[r[1]]],
				f = s.queue().length;
			o && (a = (parseInt(o[1], 10) / 100) * p[+("hide" !== n)]),
				(c.clip[r[0]] = a),
				(d.clip[r[0]] = a),
				(d.clip[r[1]] = 0),
				"show" === n && (s.cssClip(d.clip), h && h.css(t.effects.clipToBox(d)), (d.clip = u)),
				s
					.queue(function (i) {
						h && h.animate(t.effects.clipToBox(c), l, e.easing).animate(t.effects.clipToBox(d), l, e.easing), i();
					})
		...
		t.effects.define("size", function (e, i) {
			...
			t.effects.createPlaceholder(o),
				...
				("box" === d || "both" === d) && (n.from.y !== n.to.y && ((_ = t.effects.setTransition(o, l, n.from.y, _)), (v = t.effects.setTransition(o, l, n.to.y, v))), n.from.x !== n.to.x && ((_ = t.effects.setTransition(o, h, n.from.x, _)), (v = t.effects.setTransition(o, h, n.to.x, v)))),
				("content" === d || "both" === d) && n.from.y !== n.to.y && ((_ = t.effects.setTransition(o, r, n.from.y, _)), (v = t.effects.setTransition(o, r, n.to.y, v))),
				...
				("content" === d || "both" === d) &&
					...
					o.find("*[width]").each(function () {
						...
						n.from.y !== n.to.y && ((a = t.effects.setTransition(i, l, n.from.y, a)), (o = t.effects.setTransition(i, l, n.to.y, o))),
							n.from.x !== n.to.x && ((a = t.effects.setTransition(i, h, n.from.x, a)), (o = t.effects.setTransition(i, h, n.to.x, o))),
				...
				o.animate(v, {
					...
					complete: function () {
						var e = o.offset();
						0 === v.opacity && o.css("opacity", _.opacity), c || (o.css("position", "static" === f ? "relative" : f).offset(e), t.effects.saveStyle(o)), i();
					},
				});
		}),
		t.effects.define("scale", function (e, i) {
			var s = t(this),
				n = e.mode,
				a = parseInt(e.percent, 10) || (0 === parseInt(e.percent, 10) ? 0 : 100 * ("effect" === n)),
		...
		t.effects.define("pulsate", "show", function (e, i) {
			var s = t(this),
				n = e.mode,
				a = "show" === n,
				o = 2 * (e.times || 5) + +!!(a || "hide" === n),
				r = e.duration / o,
				l = 0,
				h = 1,
				u = s.queue().length;
			for ((a || !s.is(":visible")) && (s.css("opacity", 0).show(), (l = 1)); h < o; h++) s.animate({ opacity: l }, r, e.easing), (l = 1 - l);
			s.animate({ opacity: l }, r, e.easing), s.queue(i), t.effects.unshift(s, u, o + 1);
		}),
		t.effects.define("shake", function (e, i) {
			var s = 1,
				...
				f = {},
				g = n.queue().length;
			for (t.effects.createPlaceholder(n), d[u] = (c ? "-=" : "+=") + o, p[u] = (c ? "+=" : "-=") + 2 * o, f[u] = (c ? "-=" : "+=") + 2 * o, n.animate(d, h, e.easing); s < r; s++) n.animate(p, h, e.easing).animate(f, h, e.easing);
			n
		...
		t.effects.define("slide", "show", function (e, i) {
			var s,
				...
				c = {};
			t.effects.createPlaceholder(a), (s = a.cssClip()), (n = a.position()[h]), (c[h] = ("up" === l || "left" === l ? -1 : 1) * u + n), (c.clip = a.cssClip()), (c.clip[o[l][1]] = c.clip[o[l][0]]), "show" === r && (a.cssClip(c.clip), a.css(h, c[h]), (c.clip = s), (c[h] = n)), a.animate(c, { queue: !1, duration: e.duration, easing: e.easing, complete: i });
		}),
		!0 === t.uiBackCompat &&
